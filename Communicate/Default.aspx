...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server" CommandName="study">
    <div>
        ...
        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="#" 
            CommandName="life" onclick="ImageButton1_Click" />
        <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="#" 
            CommandName="competiton" onclick="ImageButton1_Click" />
        <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="#" 
            CommandName="amusement" onclick="ImageButton1_Click" />
        <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="#" CommandName="commerce" onclick="ImageButton1_Click"/>
    </div>
    <div>
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            DataSourceID="SqlDataSource4" BorderStyle="None" GridLines="None">
        <Columns>
            <asp:HyperLinkField DataTextField="UserName" DataNavigateUrlFields = "UserName" 
                    DataNavigateUrlFormatString = "~/MyDetail.aspx?usName = {0}" HeaderText="UserName"/>
            <asp:HyperLinkField DataTextField="Title" DataNavigateUrlFields = "TopicID" 
    ...
    <div>
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
            DataSourceID="SqlDataSource3" BorderStyle="None" GridLines="None">
            <Columns>
